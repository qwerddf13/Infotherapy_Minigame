...
namespace Dan.Demo
{
    public class LeaderboardShowcase : MonoBehaviour
    {
        ...
        public void Load()
        {
            ...
            Leaderboards.WoodChop.GetEntries(searchQuery, OnLeaderboardLoaded, ErrorCallback);
        ...
        public void Submit()
        {
            Leaderboards.WoodChop.UploadNewEntry(_playerUsernameInput.text, _playerScore, Callback, ErrorCallback);
        }
        
        public void DeleteEntry()
        {
            Leaderboards.WoodChop.DeleteEntry(Callback, ErrorCallback);
        }
        ...
        {
            Leaderboards.WoodChop.GetPersonalEntry(OnPersonalEntryLoaded, ErrorCallback);
        }
